                    ...
                    <div class="header-info">
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a
                                    href="tel:{{ $settings["phone"] ?? '9671434335' }}">{{ $settings["phone"] ?? '9671434335' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <!-- <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span> -->
                            <span class="icontop"><img src="images/service-icon3.png" alt="#"></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $settings["email"] ?? 'rs.hospital@gmail.com' }}">{{ $settings["email"] ?? 'rs.hospital@gmail.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <!-- <span class="icontop"><i class="fa fa-clock-o" aria-hidden="true"></i></span> -->
                            <span class="icontop"><img src="images/service-icon5.png" alt="#"></span>
                ...
                <div class="col-md-4">
                    <div class="logo padding">
                        <a href="images/logo.png"
                                alt=""></a>
                                <p>'Welcome to Sangwan Hospital, where compassionate care meets advanced medical technology. Our mission is to provide exceptional healthcare services to enhance the well-being of our community.' 
                                </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker"
                                aria-hidden="true"></i>'H7V6+V89 , Loharu Rd , Charkhi Dadri , Haryana 127306' 
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $settings["email"] ?? 'rs.hospital@gmail.com' }}
                        </p>
                        <p><i class="fa fa-phone"
                                aria-hidden="true"></i>{{ $settings["phone"] ?? '9671434335' }}</p>
                    </div>
                </div>
                @livewire('subscribe')
            </div>
                ...
                <div class="col-md-8">
                    <div class="footer-text">
                        <p>© {{ date('Y') }} <a id="tw" href="{{ url('') }}"
                                target="_blank">RS Sangwan Hospital</a></p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="social">
